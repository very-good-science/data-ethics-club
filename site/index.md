...
We send out regular reminders of our meetings to [our mailing list](http://eepurl.com/hjkmnX), so joining it is the best way to regularly hear about [our upcoming meetings](contents/upcoming-meetings).

For details of our next meeting, [click here](contents/meetings/next-meeting)
```

## Community Contributors

Data Ethics Club is organised by a [small team](contact), but has been built by a big community of data ethics enthusiasts! Check out our community contributors below. ✨
...
:maxdepth: 2
:hidden:
contents/join_in/join_in
contents/reading-list
contents/write_ups/write-ups
contents/how_to/reuse_dec.md
contents/contact
```