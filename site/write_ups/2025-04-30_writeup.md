...
Since large language models (LLMs) entered into the mainstream, an important discussion has ensued regarding their effect on education. Much this discussion has centred around the implications for students, raising questions about whether students will continue to learn when they can easily use LLMs to write their essays or cheat in exams. Whilst the student perspective is important, there has been much less attention on what LLMs mean for teachers, and how teachers are adopting and using AI in their work. 
